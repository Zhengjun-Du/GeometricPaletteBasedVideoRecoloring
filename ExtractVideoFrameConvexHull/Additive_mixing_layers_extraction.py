...
#             if outside_ratio>num_thres:
            ...
            if option=="all_pixel_colors": ### basic one.
                ...
                try:
                    ...
                    print("QhullError!")
                    useless_hull=ConvexHull(old_vertices)
                    return useless_hull.points[ useless_hull.vertices ].clip(0.0,1.0)
            ...
            if reconstruction_errors>error_thres:
                ...
                if SAVE:
                    ...
                    # add by zhengjun
                    oldhull.points[ oldhull.vertices ] = oldhull.points[ oldhull.vertices ].clip(0.0,1.0)
                    write_convexhull_into_obj_file(oldhull, output_rawhull_obj_file)
        ...
        if len(hull.vertices)==old_num or len(hull.vertices)==4:
            ...
            if SAVE:
                ...
                # add by zhengjun
                hull.points[ hull.vertices ] = hull.points[ hull.vertices ].clip(0.0,1.0)
                write_convexhull_into_obj_file(hull, output_rawhull_obj_file)
